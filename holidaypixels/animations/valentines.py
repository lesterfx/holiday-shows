...
class Animation(object):
    colors = []
    colors.append(Color(.4**3, 0**3, 1**3))
    colors.append(Color(1**3, 0**3, 1**3))
    colors.append(Color(1**3, 0**3, .2**3))
    ...
    def main(self, end_by):
        ...
        self.sleep = .5
        self.make_particle = self.home.run_every(0, self._make_particle)
    ...
    def _make_particle(self):
        ...
        self.make_particle.seconds = self.sleep ** 8 * 30
        color = self.color(luma=0, mode='max')
